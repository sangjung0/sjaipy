...
class AMI:
    ...
    def load_train_ihm(self) -> tuple[RecordingSet, SupervisionSet]:
        return self.__load_set("ihm", "train")

    def load_dev_ihm(self) -> tuple[RecordingSet, SupervisionSet]:
        return self.__load_set("ihm", "dev")

    def load_test_ihm(self) -> tuple[RecordingSet, SupervisionSet]:
        return self.__load_set("ihm", "test")

    def load_train_sdm(self) -> tuple[RecordingSet, SupervisionSet]:
        return self.__load_set("sdm", "train")

    def load_dev_sdm(self) -> tuple[RecordingSet, SupervisionSet]:
        return self.__load_set("sdm", "dev")

    def load_test_sdm(self) -> tuple[RecordingSet, SupervisionSet]:
